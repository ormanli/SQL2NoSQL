 ...
 */
public class App {
	private static final String DEMO_STATEMENTS = "SELECT * FROM t;" + "SELECT x, y, z FROM t;" + "SELECT t1.g, t2.h FROM t1,t2;" + "INSERT INTO t(a,s,d,f) VALUES (1,2,3,4);" + "UPDATE t SET x=1, y=2 WHERE z>100;" + "DELETE FROM t WHERE n=5 AND m=50;";
	...
	public static void main(String[] args) throws Exception {
		...
		// if(echoStatement) {
		// System.out.println(sql.substring(node.getBeginOffset(),
		// node.getEndOffset() + 1));
		// }
